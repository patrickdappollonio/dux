//! HTTP endpoints for the web code editor: list the worktree's files, and read
//! and write a file's working copy. Request/response so the editor gets real
...
//! git's file set (tracked + untracked-not-ignored) purely so the tree is a
//! clean, finite browse surface — it does not bound what is editable.
//!
