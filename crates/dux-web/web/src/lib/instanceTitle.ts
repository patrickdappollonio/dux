 ...
 * missing, empty, or whitespace-only. Used for both the browser tab title and the
 * brand wordmark so the two surfaces never drift (browsers truncate a tab title at
 * a newline, so the collapse keeps the tab and the wordmark identical).
 */
