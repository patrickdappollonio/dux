...
import { SIDEBAR_RESIZING_NO_TRANSITION } from "@/lib/paneDivider"
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          // The tween belongs to the collapse toggle; a drag suppresses it so
          // the edge sits under the finger. See SIDEBAR_RESIZING_ATTR.
