...
- **Double-click actions must be item-specific.** When a double-click activates a row, line, or other target, both clicks must resolve to the same exact item, not just the same pane or region.
